...
namespace ui
{
    ...
    bool itemModified() { return item_mod; }
    ...
    ui::Trans2d affineSimple( int index, ui::Trans2d t, bool selected, float scale )
    {
        ...
        // position
        t.pos = dragger(0, t.pos, selected, config.draggerSize ); 
        pmod = item_mod;
        ...
        // x axis
        px = t.pos + t.x*scale;
        px = dragger(1, px, false, config.draggerSize*0.7 ); 
        xmod = item_mod;
        ...
        // y axis
        py = t.pos + t.y*scale;
        py = dragger(2, py, false, config.draggerSize*0.7 ); 
        ymod = item_mod;
